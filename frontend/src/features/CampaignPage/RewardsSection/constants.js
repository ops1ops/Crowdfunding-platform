...
export const SUPPORT_CAMPAIGN = 'SUPPORT_CAMPAIGN';
export const SUPPORT_CAMPAIGN_SUCCESS = 'SUPPORT_CAMPAIGN_SUCCESS';
export const SUPPORT_CAMPAIGN_FAIL = 'SUPPORT_CAMPAIGN_FAIL';
